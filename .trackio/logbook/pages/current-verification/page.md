...
This is the current verifier. Its scientific evidence was regenerated by the
fixed command at Git SHA
`4f40cf95412121cb07d5e4a1c30f22e5ed890978` (formal run
`0d16e102-dc99-46e9-af92-bbd51a80d44f`). It supersedes the earlier pages in
...
`p=3..9` with maximum EIG error `7.44329042845493e-11`, and execution at
...
[comparison CSV](../../evidence/current/claim_1/independent_comparison.csv) and
[scaling CSV](../../evidence/current/claim_1/scaling.csv); result:
[JSON](../../evidence/current/claim_1/result.json); checker:
[JSON](../../evidence/current/claim_1/independent_checker.json); control:
[JSON](../../evidence/current/claim_1/negative_control.json); verifier:
...
|---|---:|---:|---:|---:|
| Bike Sharing / RF | 0.010953 | 0.005481 | 1.837 [1.489, 2.257] | 0.000471344 |
| Bike Sharing / GB | 0.011583 | 0.006439 | 1.655 [1.384, 1.978] | 0.000603151 |
| California Housing / GB | 0.009047 | 0.004335 | 1.967 [1.623, 2.359] | 3.57628e-05 |
...
`247.824729416 s` for the five-restart GP fit and `11.584338084 s` for the
